...
impl Display for MiddleApi {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(
            ...
            "MiddleApi \n - my: {} | {}\n - opp: {} | {}\n - match_type: {}\n - win: {} | {}\n - explain_ch: {}\n - explain_en: {}\n - email: {}\n - match_strategy: {}\n - round_score: {}\n - err: {}",
            self.my_tag,
            self.my_name.as_ref().unwrap_or(&String::new()),
            self.opp_tag,
            self.opp_name.as_ref().unwrap_or(&String::new()),
            self.match_type.as_ref().unwrap_or(&String::new()),
            self.win_tag,
            self.win_name.as_ref().unwrap_or(&String::new()),
            self.explain_ch.as_ref().unwrap_or(&String::new()),
            self.explain_en.as_ref().unwrap_or(&String::new()),
            self.email.as_ref().unwrap_or(&String::new()),
            self.match_strategy.as_ref().unwrap_or(&String::new()),
            self.round_score,
            self.err,
        )
    }
